...
import smratiGarg.utility.ExcelOperations;
...
public class Jul05ExcelDataProviderTc3 {
    ...
    public Object[][] getData() throws IOException {
        List<Map<String, String>> data = ExcelOperations.readExcel("src/smratiGarg/testData/mar26-data-driven.xlsx", "orderPlacement");
...
//        String dish = restauarantMenuPage.getFirstAvailableDish();
        ...
        int qnty = (int)Double.parseDouble(data.get("quantity"));
        ...
        orderSummaryCheckoutPage.setDeliveryAddress(data.get("location"));

        System.out.println("STEP - Enter a valid mobile number");
        orderSummaryCheckoutPage.setPhoneNum(data.get("phoneNumber"));
