package smratiGarg.PageFactory.testScript;
...
import smratiGarg.PageFactory.pages.LoginPage;
import smratiGarg.PageFactory.base.BrowserAction;
import smratiGarg.PageFactory.pages.*;


public class ASgn17_19Pagefactory {
    ...
    public void setup(){
        ...
        BrowserAction.start("http://34.66.197.232/#/access");
