...
public class Ass13 {
    ...
    public void multiSelectDropDown() {
        ...
        numberSelect.deselectByIndex(1);

        System.out.println("Retrieve the selected values after deselecting 2");
        List<WebElement> selectedOptions2 = numberSelect.getAllSelectedOptions();
        for (WebElement e : selectedOptions2)
            System.out.println(e.getText());
