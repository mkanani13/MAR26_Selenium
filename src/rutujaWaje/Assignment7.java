...
public class Assignment7 {
    @Test
    public void checkboxandradiosection() throws InterruptedException {
        System.out.println("Launch Browser");
            ...
            WebElement checkbox = driver.findElement(By.xpath("//div[@class='checkbox'][2]/label/input"));
            JavascriptExecutor js = (JavascriptExecutor) driver;
            js.executeScript("arguments[0].scrollIntoView(true);", checkbox);
            Thread.sleep(1000);
            checkbox.click();
            Assert.assertTrue(checkbox.isSelected(),"FAIL : Checkbox is not selected.");
            driver.quit();
        }
    }
