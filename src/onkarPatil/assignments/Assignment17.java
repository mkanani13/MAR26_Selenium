...
public class Assignment17 {
    ...
    public void orderItemsAndVerifyOrder() throws InterruptedException {
        ...
        WebElement captcha = wait.until(ExpectedConditions.elementToBeClickable(driver.findElement(By.id("pay-captcha"))));
        ...
        WebElement finalOrderPageElement = wait.until(ExpectedConditions.visibilityOf(driver.findElement(By.xpath("(//td[contains(@data-testid,'order-number')])[1]"))));
