...
public class Assignment19 {
    ...
    public void orderItemsAndVerifyOrder() throws InterruptedException {
        ...
        WebElement selectDropdown = driver.findElement(By.id("coupon-code"));
        Select select1 = new Select(selectDropdown);
        select1.selectByValue("PUNE50");

        JavascriptExecutor js = (JavascriptExecutor) driver;
        js.executeScript("arguments[0].scrollIntoView(true)", driver.findElement(By.id("proceed-checkout-btn")));
        String subTotalAmtText = driver.findElement(By.id("ot-subtotal")).getText().substring(1);
        double subTotalAmt = Double.parseDouble(subTotalAmtText);
        double expectedPayableAmt = subTotalAmt*0.9;
        double expectedDiscount = subTotalAmt-expectedPayableAmt;

        String discountAmtText = driver.findElement(By.id("ot-discount")).getText().substring(1);
        ...
        String finalPayableAmtText = driver.findElement(By.xpath("//span[@data-testid='payment-total']")).getText().substring(1);
        double finalPayableAmt = Double.parseDouble(finalPayableAmtText);
        ...
        WebElement errorMessageElement = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@data-testid='fd-toast-error']")));
